...
## Su señoría, laburo
Todo servidor serio utiliza Linux, por lo que se vuelve una habilidad muy práctica. La virtualización está implementada a nivel de kernel, por lo que las máquinas virtuales y los Dockers se ejecutan nativamente. Usar Linux te obliga a entender cómo funciona un sistema operativo.
...
Hay juegos que literalmente no se pueden jugar debido a que su anti-cheat requiere un kernel Windows, por ejemplo, Apex Legends, Valorant, Rainbow's Six Siege y League of Legends.
